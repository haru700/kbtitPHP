 ...
 * @version   CVS: $Id: category.php,v 1.1 2008/04/28 15:59:30 tetsuya Exp $
 ...
 * @link      http://phpize.net
 */
class Services_Yahoo_JP_Auction_Category
    extends Services_Yahoo_JP_Auction_AbstractAuction
{
     ...
     *
     * @return array A category list.
     */
    public function submit()
    {
        $res = parent::submit();
        $res->setIndexKey('childCategory');
        return $res;
    }
}
?>
